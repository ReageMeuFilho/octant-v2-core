...
contract ETH2StakeVaultTest is SetupIntegrationTest {
    ...
    function test_FullDepositLifecycle() public {
        ...
        (
            state /*withdrawalAddress*/ /*withdrawalCredentials*/ /*pubkey*/ /*signature*/ /*depositDataRoot*/,
            ,
            ,
            ,
            ,
            ,
            assignedOperator /*confirmedTimestamp*/,
        ...
        (
            state /*withdrawalAddress*/ /*withdrawalCredentials*/ /*pubkey*/ /*signature*/,
            ,
            ,
            ,
            ,
            depositDataRoot /*assignedOperator*/ /*confirmedTimestamp*/,
            ,

        ) = nonfungibleDepositManager.deposits(tokenId);
        assertEq(
            uint256(state),
            uint256(NonfungibleDepositManager.DepositState.Confirmed),
            "Wrong state after confirm"
        );
        ...
        (
            state /*withdrawalAddress*/ /*withdrawalCredentials*/ /*pubkey*/ /*signature*/ /*depositDataRoot*/ /*assignedOperator*/ /*confirmedTimestamp*/,
            ,
            ,
            ,
            ,
        ...
        assertEq(
            uint256(state),
            uint256(NonfungibleDepositManager.DepositState.Finalized),
            "Wrong state after finalize"
        );

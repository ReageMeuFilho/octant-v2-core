...
contract MockDepositContract is IDepositContract {
    ...
    event DepositMade(bytes pubkey, bytes withdrawal_credentials, bytes signature, bytes32 deposit_data_root);
    ...
    function deposit(
        ...
        emit DepositMade(pubkey, withdrawal_credentials, signature, deposit_data_root);
    }
}

...
import { IMintable } from "staker/interfaces/IMintable.sol";
...
contract ERC20VotesMock is IERC20Staking, IMintable, ERC20Permit {
    ...
    function allowance(address account, address spender) public view override(IERC20, ERC20) returns (uint256) {
    ...
    function approve(address spender, uint256 rawAmount) public override(IERC20, ERC20) returns (bool) {
    ...
    function transferFrom(address src, address dst, uint256 rawAmount) public override(IERC20, ERC20) returns (bool) {

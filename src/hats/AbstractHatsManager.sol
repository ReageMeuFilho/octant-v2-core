...
abstract contract AbstractHatsManager is IHatsEligibility, IHatsToggle {
     ...
     * @param branchName Human-readable name for the branch
     */
    constructor(
        address hats, 
        uint256 _adminHat,
        ...
        // Create the branch admin hat under the admin hat
        // createHat(
        //    uint256 admin,            // Parent hat ID
        //    string calldata details,  // Human-readable description
        //    uint32 maxSupply,        // Maximum number of wearers
        //    address eligibility,     // Eligibility checker contract
        //    address toggle,          // Toggle control contract
        //    bool mutable_,          // Can be modified by admin
        //    string calldata imageURI // Optional image URI
        // )
        branchHat = HATS.createHat(
            adminHat,
            branchName,
            1,              // Only one admin for branch
            address(this),  // this contract handles eligibility
            address(this),  // this contract handles toggle
            true,          // mutable
            ""            // imageURI
        );
        // NOTE: better to not do this atomically - mint the branch hat to this contract
        // HATS.mintHat(branchHat, address(this));
    }

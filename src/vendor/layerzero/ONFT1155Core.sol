...
import "@layerzero/contracts/token/onft1155/interfaces/IONFT1155Core.sol";
...
abstract contract ONFT1155Core is NonblockingLzApp, ERC165, IONFT1155Core {
    ...
    constructor(address _lzEndpoint, address _owner) NonblockingLzApp(_lzEndpoint, _owner) {}

...
import "@layerzero/contracts/token/onft1155/interfaces/IONFT1155.sol";
...
contract ONFT1155 is ONFT1155Core, ERC1155, IONFT1155 {
    constructor(string memory _uri, address _lzEndpoint, address _owner) ERC1155(_uri) ONFT1155Core(_lzEndpoint, _owner) {}

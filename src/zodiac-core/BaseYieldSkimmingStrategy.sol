 ...
 * @notice
 *  BaseYieldSkimmingStrategy implements all of the required functionality to
 *  seamlessly integrate with the `TokenizedStrategy` implementation contract
 *  allowing anyone to easily build a fully permissionless ERC-4626 compliant
 *  Vault by inheriting this contract and overriding three simple functions.
 *  The main difference between this and BaseStrategy is that this contract
 *  is that is has a different harvestAndReport function that returns int256 deltaAtNewRate, int256 deltaAtOldRate;
 *
...
abstract contract BaseYieldSkimmingStrategy {
     ...
     */
    function harvestAndReport() external virtual onlySelf returns (int256 deltaAtNewRate, int256 deltaAtOldRate) {

 ...
 * @dev Located in zodiac-core/vaults/ - distinct from zodiac-core/TokenizedStrategy.sol
 *      This variant adds vault-specific features on top of base Zodiac integration
 *
 *      ARCHITECTURE:
 *      - Extends base Zodiac TokenizedStrategy
 *      - Adds vault-specific state and functionality
 *      - Maintains compatibility with DragonTokenizedStrategy
 *
 *      See zodiac-core/TokenizedStrategy.sol for base Zodiac functionality

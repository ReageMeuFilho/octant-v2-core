...
contract AllocationMechanismFactory {
    ...
    /**
     * @notice Thrown when attempting to deploy with parameters matching existing mechanism
     * @param existingMechanism Address of the already deployed mechanism
     * @dev Prevents parameter confusion and ensures deterministic addresses
     */
     ...
     * @return predicted The deterministic CREATE2 address where mechanism will be deployed
     */
     ...
     * @return count The number of mechanisms deployed by this factory

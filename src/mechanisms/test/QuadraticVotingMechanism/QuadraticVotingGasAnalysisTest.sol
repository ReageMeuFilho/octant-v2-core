...
contract QuadraticVotingGasAnalysisTest is Test {
    ...
    function testWarmStorageVoting() public {
        ...
        users[0] = alice2; users[1] = bob2; users[2] = charlie2; users[3] = david2;
    ...
    function testVotingWeightImpactOnGas() public {
        ...
        emit GasComparison("Medium_vs_Small_Weight", gasMediumWeight, gasSmallWeight, mediumSmallDiff, mediumSmallDiff > 0 ? (mediumSmallDiff * 100) / gasSmallWeight : 0);
        emit GasComparison("Large_vs_Medium_Weight", gasLargeWeight, gasMediumWeight, largeMediumDiff, largeMediumDiff > 0 ? (largeMediumDiff * 100) / gasMediumWeight : 0);
        emit GasComparison("Large_vs_Small_Weight", gasLargeWeight, gasSmallWeight, largeSmallDiff, largeSmallDiff > 0 ? (largeSmallDiff * 100) / gasSmallWeight : 0);
    ...
    function testSequentialVotingAcrossProjects() public {
        ...
        pids[0] = pid1; pids[1] = pid2; pids[2] = pid3; pids[3] = pid4; pids[4] = pid5;
        ...
        if (gasUsed[0] > avgSubsequent) {
            ...
            emit GasComparison("First_vs_Avg_Subsequent_Votes", gasUsed[0], avgSubsequent, firstVotePenalty, penaltyPercent);
        }
    ...
    function _setupUsers() internal {
        ...
        address[] memory users = new address[](4);
        users[0] = alice; users[1] = bob; users[2] = charlie; users[3] = david;

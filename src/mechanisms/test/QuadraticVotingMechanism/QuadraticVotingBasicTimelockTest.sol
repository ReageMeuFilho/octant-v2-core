...
contract QuadraticVotingBasicTimelockTest is Test {
    ...
    function testBasicTimelock() public {
        ...
        assertEq(_tokenized(address(mechanism)).redeemableAfter(charlie), 0, "Should have no redeemableAfter before queue");
        ...
        assertEq(_tokenized(address(mechanism)).redeemableAfter(charlie), queueTime + 1000, "Should have correct redeemableAfter");

...
contract DebugQuorum is Test {
    ...
    function testDebugQuorum() public {
        ...
        try mechanism.getProposalFunding(pid) returns (uint256 _sumContributions, uint256 _sumSquareRoots, uint256 _quadraticFunding, uint256 _linearFunding) {
        ...
        uint256 correctWeightedFunding = quadraticFunding + (linearFunding * (alphaDenominator - alphaNumerator)) / alphaDenominator;

...
/**
 * @title YearnV3 Base Yield Skimming Strategy
 * @author Octant
 * @notice
 ...
 *
 * @dev IMPORTANT: This is a YieldSkimmingStrategy variant that differs from the
 *  standard BaseStrategy. The key difference is that `_harvestAndReport()` returns
 *  an int256 representing the DELTA (change in value, positive or negative) instead of uint256 
 *  representing totalAssets. This design is optimized for strategies that "skim"
 *  yield while maintaining a relatively stable principal, making it more efficient
 *  to report only the profit delta rather than recalculating total assets each time.
 */
abstract contract BaseYieldSkimmingStrategy {
    /*//////////////////////////////////////////////////////////////
                            MODIFIERS
    //////////////////////////////////////////////////////////////*/
    /**

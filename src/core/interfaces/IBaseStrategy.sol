...
interface IBaseStrategy {
     ...
     * @param _amount Amount of asset the strategy can deploy in asset base units
     */
     ...
     * @param _amount Amount of asset that the strategy should free up in asset base units
     */
     ...
     * @param _totalIdle Amount of idle funds available to deploy in asset base units
     */

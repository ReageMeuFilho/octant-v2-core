...
/**
 * @title Yearn V3 Base Yield Skimming Strategy Interface
 * @author Octant
 * @notice
 *  This interface defines the functions that a BaseYieldSkimmingStrategy must implement
 *  to be compatible with the YieldSkimmingTokenizedStrategy contract.
 *
 ...
 */
interface IBaseYieldSkimmingStrategy {
    /*//////////////////////////////////////////////////////////////
                        CALLBACKS FUNCTIONS
    //////////////////////////////////////////////////////////////*/

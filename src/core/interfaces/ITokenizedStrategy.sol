...
interface ITokenizedStrategy is IERC4626, IERC20Permit {
     ...
     * @param assets Amount of underlying to withdraw in asset base units
     ...
     * @param owner Address whose shares are burnt
     * @param maxLoss Maximum acceptable loss in basis points (1 bps = 0.01%)
     * @return Actual amount of underlying withdrawn in asset base units
     */
     ...
     * @return Maximum withdrawable amount in asset base units
     */

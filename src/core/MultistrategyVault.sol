...
contract MultistrategyVault is IMultistrategyVault {
     ...
     * @param depositLimit_ New maximum total assets in asset base units (use type(uint256).max for unlimited)
     ...
     * @param minimumTotalIdle_ Minimum idle assets in asset base units (0 = no minimum)
     ...
     * @return Amount of shares unlocked (in share base units, typically 18 decimals)
     */
     ...
     * @return Price per share in asset base units (e.g., 1.05e18 = 1.05 assets per share)
     */
     ...
     * @return gain Amount of profit generated since last report (in asset base units)
     * @return loss Amount of loss incurred since last report (in asset base units)
     ...
     * @param amount_ Amount of debt to purchase in asset base units (capped at current debt)
     ...
     * @param newMaxDebt_ Maximum debt in asset base units (0 = no new allocations)
     ...
     * @param targetDebt_ Target debt in asset base units (or type(uint256).max for max allocation)
     ...
     *
     * @param assets_ Amount of assets to deposit in asset base units (or type(uint256).max for full balance)
     ...
     *
     * @param assets_ Amount of assets to withdraw in asset base units
     ...
     * @return balance Share balance (in share base units, typically 18 decimals)
     */
     ...
     * @return supply Total circulating shares (in share base units)
     */
     ...
     * @return assets Total assets in asset base units
     ...
     * @return idle Idle assets in asset base units
     */
     ...
     * @return debt Total debt in asset base units
     */
     ...
     * @return max Maximum deposit amount in asset base units (0 if deposits disabled)
     */
     ...
     * @param receiver_ Address that would receive the shares
     * @return max Maximum mint amount in shares (0 if deposits disabled)
     */
     ...
     * @return max Maximum withdrawable assets in asset base units
     */
     ...
     * @return loss User's share of unrealized losses in asset base units
     */

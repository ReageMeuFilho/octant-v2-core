...
contract RegenEarningPowerCalculator is IAccessControlledEarningPowerCalculator, Ownable, ERC165 {
     ...
     *      - No access: 0
     * @param stakedAmount The amount of staked tokens (in token base units)
     * @param staker The address of the staker
     * @return earningPower The calculated earning power (0 if no access)
     */
     ...
     * @param stakedAmount The amount of staked tokens (in token base units)
     * @param staker The address of the staker
     * @param oldEarningPower The previous earning power value
     * @return newCalculatedEarningPower The new earning power (0 if no access)
     ...
     * @param _allowset The allowset contract address to set
     ...
     * @dev Only callable by owner. Use setAccessMode(AccessMode.NONE) to disable access control
     * @param _blockset The blockset contract address to set
     * @custom:security Only owner can modify access control
     */

 ...
 * @author yearn.finance, Octant
 * @notice
 *  BaseStrategy implements all of the required functionality to
 *  seamlessly integrate with the `OctantTokenizedStrategy` implementation contract
 ...
 *  the strategy if desired. The yield should be tracked separately from principal
 *  and the strategy should be able to report the total value of the assets it has deployed 
 *  as well as the total profit generated by the strategy.
 *
...
abstract contract BaseStrategy {
     ...
     */
    address public constant TOKENIZED_STRATEGY_ADDRESS = 0xDFC8cD9F2f2d306b7C0d109F005DF661E14f4ff2;
    ...
    constructor(address _asset, string memory _name) {
        ...
        // Store the TOKENIZED_STRATEGY_ADDRESS at the standard implementation

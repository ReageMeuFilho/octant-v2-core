...
// @dev This module is a modified version of the Gnosis Safe Modules v0.1.1 AllowanceModule.sol
// @dev https://github.com/safe-global/safe-modules/blob/allowance/v0.1.1/modules/allowances/contracts/AllowanceModule.sol
// @dev Minor Modifications:
// @dev - Changed solidity version to >=0.8.0 <0.9.0
// @dev - Casted address to uint160 before casting to uint48.
// @dev - Casted tx.origin to payable address.
...
contract AllowanceModule is SignatureDecoder {
    ...
    function getTokenAllowance(address safe, address delegate, address token) public view returns (uint256[5] memory) {
        ...
        uint256 resetTime = uint256(allowance.resetTimeMin) * 60;
